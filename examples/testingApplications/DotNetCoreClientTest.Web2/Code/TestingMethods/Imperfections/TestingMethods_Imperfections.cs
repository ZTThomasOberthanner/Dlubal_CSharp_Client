    ...
    public static partial class TestingMethods
    {
        ...
        private static void SetImperfectionCase(int caseNo, imperfection_case_type type, int tableRowCount = 0)
        {
            ...
            switch (type)
            {
                ...
                case imperfection_case_type.IMPERFECTION_TYPE_LOCAL_IMPERFECTIONS:
                {
        ...
        public static bool Test_Imperfections_Imperfection\u2040Cases_Create()
        {
            ...
            try
            {
                ...
                SetImperfectionCase(IMPERFECTION_CASE_5_NO, imperfection_case_type.IMPERFECTION_TYPE_LOCAL_IMPERFECTIONS);
